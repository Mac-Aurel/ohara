...
Le cœur de la persistance. Il expose les routes articles, utilisateurs, chunks et commentaires, et porte toute la logique de clustering par histoire : quand un article est sauvegardé, son titre + résumé sont transformés en embedding puis comparés à celui de l'article le plus proche déjà en base. Si la similarité dépasse 0.88, l'article rejoint son `story_id`, sinon il en reçoit un nouveau. Un essai de comparaison au centroïde de chaque histoire (plutôt qu'au seul article le plus proche) a été tenté puis abandonné : une fois qu'une histoire compte assez de membres, son centroïde converge vers un « texte d'actualité générique » qui attire n'importe quel nouvel article de la même langue, sans rapport de sujet. Le seuil de 0.88 est calibré sur des mesures réelles du corpus (doublons authentiques entre 0.89 et 0.96 de similarité, articles sans rapport jusqu'à 0.84).
